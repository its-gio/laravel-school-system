        ...
        >
            <g xmlns="http://www.w3.org/2000/svg">
                <path
                    className="st0"
                    style={{ fill: '#EC1A29' }}
                    d="M882.83,0H58.58C26.36,0,0,26.36,0,58.58v280.33c0,32.22,26.36,58.58,58.58,58.58h824.26   c32.22,0,58.58-26.36,58.58-58.58V58.58C941.41,26.36,915.05,0,882.83,0z"
                />
                <g>
                    <path
                        className="st1"
                        style={{ fill: '#FFF' }}
                        d="M326.85,201.47c0-13.7-13.65-33.14-35.88-33.14l-87.74,0.14c0,27.35,18.25,50.6,41.03,58.03v57.61h-92.51    V113.72l92.68,0.1c31.54,0,54.45-25.8,54-55.08l-193.47,0.03c-21.48,0.46-35.93,18.31-35.93,35.49    c0,24.97,0.13,206.17,0.13,208.36c0,20.57,16.11,36.21,36.23,36.21c13.31,0,187.12,0,185.02,0c22.83,0,36.54-18.14,36.54-36.21    L326.85,201.47z"
                    />
                    <path
                        className="st1"
                        style={{ fill: '#FFF' }}
                        d="M581.35,113.17H501.8l-0.09,235.69c-54.91,0-78.39-47.41-78.39-74.69l-0.29-161h-33.08    c-28.9,0-54.63-22.56-54.63-54.52l209.59,0.06c16.99,0,36.44,13.24,36.44,36.41V113.17z"
                    />
                    <path
                        className="st1"
                        style={{ fill: '#FFF' }}
